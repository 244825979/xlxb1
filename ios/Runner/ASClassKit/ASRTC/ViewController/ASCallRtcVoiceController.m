...
@interface ASCallRtcVoiceController ()<NERtcCallKitDelegate, ASWebSocketDelegate>
@property (nonatomic, strong) ASAnswerRiskView *riskHintView;
...
@implementation ASCallRtcVoiceController
            ...
            [wself closeWithCompletion:^{
                ...
                switch (type.integerValue) {
                    ...
                    case 6:
                        ...
                        break;
                    case 10:
                        kShowToast(@"本次语音违规，请遵守平台相关规则。");
                        break;
                    case 11:
                        kShowToast(@"因对方语音通话违规系统挂断，请严格遵守平台相关规定。");
                        break;
                    default:
                        break;
                }
...
- (UIImageView *)backgroundMask {
    if (!_backgroundMask) {
        ...
        [_backgroundMask sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",SERVER_IMAGE_URL, self.callModel.to_avatar]]];
