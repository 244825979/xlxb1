...
@interface FaceUnityRecorder ()

@property (nonatomic,strong) NSString *logPath;

@end

@implementation FaceUnityRecorder

+ (FaceUnityRecorder *)shareRecorder{
    static FaceUnityRecorder *_shareRecorder = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _shareRecorder = [[FaceUnityRecorder alloc] init];
    });
