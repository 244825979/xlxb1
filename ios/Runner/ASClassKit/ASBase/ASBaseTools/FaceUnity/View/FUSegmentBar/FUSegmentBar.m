...
- (void)setSelected:(BOOL)selected {
    ...
    if (selected) {
        self.segmentTitleLabel.textColor = self.segmentSelectedTitleColor ? self.segmentSelectedTitleColor : MAIN_COLOR;
    } else {
...
- (UILabel *)segmentTitleLabel {
    if (!_segmentTitleLabel) {
        ...
        _segmentTitleLabel.font = TEXT_FONT_16;
