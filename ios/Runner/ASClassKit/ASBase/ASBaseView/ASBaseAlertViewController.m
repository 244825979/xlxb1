...
- (void)viewWillAppear:(BOOL)animated {
    ...
    ASLog(@"----viewWillAppear---当前view上面是否有浮窗的数量： %zd-----isFirstPop = %d",self.view.subviews.count, self.isFirstPop);
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    self.isFirstPop = NO;
    ASLog(@"---viewWillDisappear----当前view上面是否有浮窗的数量： %zd-----isFirstPop = %d",self.view.subviews.count, self.isFirstPop);
}
