...
// 距离cell边缘的距离
public let chat_cell_margin: CGFloat = 14.0
// 控件之间的间距
public let chat_content_margin: CGFloat = 10.0
// 文本内容左右的间距
public let chat_content_left_right_margin: CGFloat = 12.0
// 文本内容上下的间距
public let chat_content_top_bottom_margin: CGFloat = 8.0
// 头像宽高
...
// 单行气泡高度
public let chat_min_h: CGFloat = 38.0
...
// 文本内容最大宽度
public let chat_text_maxW: CGFloat = chat_content_maxW - 2 * chat_content_left_right_margin
