//
//  IMFriendConversationListCell.swift
//  NEConversationUIKit
//
...
@objcMembers
open class IMFriendConversationListCell: NEBaseConversationListCell {
    override open func setupSubviews() {
        ...
        NSLayoutConstraint.activate([
            intimateIcon.leftAnchor.constraint(equalTo: title.rightAnchor, constant: 8),
            intimateIcon.centerYAnchor.constraint(equalTo: title.centerYAnchor),
            intimateIcon.heightAnchor.constraint(equalToConstant: 20),
            intimateIcon.widthAnchor.constraint(equalToConstant: 20),
        ])
        
        NSLayoutConstraint.activate([
            intimateValue.leftAnchor.constraint(equalTo: intimateIcon.rightAnchor, constant:8),
    ...
    lazy var intimateValue: UILabel = {
        ...
        label.text = "0"
        label.textColor = UIColor(hexString: "0xF63E3E")
